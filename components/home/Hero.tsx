      ...
      <div className="shell grid items-center gap-10 py-12 lg:grid-cols-2 lg:gap-14 lg:py-20">
        ...
        <div className="animate-fade-up">
          <span className="inline-flex items-center gap-2 rounded-full bg-card px-4 py-1.5 text-[13px] font-bold text-navy-800 shadow-card ring-1 ring-ink-900/5">
            ...
            آموزش تخصصی فرش، گلیم و هنرهای بافت ایرانی
          </span>
          <h1 className="mt-5 text-4xl leading-[1.5] font-black text-balance text-navy-950 sm:text-5xl sm:leading-[1.45]">
            هنر ایرانی را
            <span className="text-madder-700"> از استاد </span>
            یاد بگیرید
          </h1>
          <p className="mt-4 max-w-xl text-base leading-9 text-ink-600 sm:text-lg sm:leading-9">
            آموزش تخصصی فرش، گلیم و هنرهای بافت ایرانی به‌صورت آنلاین و حضوری؛
            از اولین گره تا بافت اثری که امضای شماست — قدم‌به‌قدم با استادکار.
          </p>
          ...
          <div className="mt-8 flex flex-wrap items-center gap-x-6 gap-y-3 text-sm text-ink-600">
            <span className="inline-flex items-center gap-2">
              ...
              <strong className="text-navy-900">+۱۲۰۰ هنرجو</strong> در حال یادگیری
            </span>
            <span className="inline-flex items-center gap-2">
              <Stars value={4.9} />
        ...
        <div className="relative animate-fade-in">
          ...
          <div className="relative overflow-hidden rounded-3xl shadow-lift">
            <Image
              src="/images/hero-weaver.jpg"
              alt="دست‌های استاد در حال گره‌زدن فرش روی دار قالی"
              width={880}
              height={660}
              priority
            ...
            <p className="absolute right-4 bottom-4 left-4 text-sm leading-7 font-semibold text-white">
              کارگاه اسدزاده — جایی که هر گره، با حوصله و اصالت زده می‌شود
            </p>
          </div>
